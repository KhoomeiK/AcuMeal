...
, function(t, e) {
    ...
    window.tram = function(t) {
          ...
          , L = l(function(e) {
            ...
            function d(t, e, n) {
                ...
                for (o in t)
                    ...
                    l.transform[o] = s) : (w.test(o) && (o = i(o)),
                    o in Z ? l[o] = s : (u || (u = {}),
                    u[o] = s));
                for (o in l) {
                    if (s = l[o],
        ...
        A.transform && A.backface && (J.z = [x, "translateZ"],
        J.rotateZ = [k],
        J.scaleZ = [g],
        J.perspective = [y]);
        var Q = /ms/
...
, function(t, e, n) {
    ...
    i.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            i = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-icon.60efbf6ec9.svg").css({
                marginRight: "8px",
                width: "16px"
            }),
...
, function(t, e, n) {
    ...
    i.define("forms", t.exports = function(t, e) {
        var r = {};
        n(7);
        var o, a, s, u, c, l = t(document), f = window.location, h = window.XDomainRequest && !window.atob, d = ".w-form", p = /e(-)?mail/i, v = /^\S+@\S+$/, m = window.alert, w = i.env(), g = /list-manage[1-9]?.com/i, b = e.debounce(function() {
        ...
        function y(e, n) {
            ...
            o.find(".w-file-upload").each(S);
            var s = r.action = i.attr("action");
            r.handler = null,
            r.redirect = i.attr("data-redirect"),
            g.test(s) ? r.handler = T : s || (a ? r.handler = E : b())
        }
        function x(t) {
        ...
        function S(e, n) {
            var i, r = t(n), o = r.find("> .w-file-upload-default"), a = r.find("> .w-file-upload-uploading"), s = r.find("> .w-file-upload-success"), u = r.find("> .w-file-upload-error"), l = o.find(".w-file-upload-input"), f = o.find(".w-file-upload-label"), h = u.find(".w-file-upload-error-msg"), d = s.find(".w-file-upload-file"), p = s.find(".w-file-remove-link"), v = d.find(".w-file-upload-file-name"), m = h.attr("data-w-size-error"), g = h.attr("data-w-type-error"), b = h.attr("data-w-generic-error");
            if (w)
                ...
                l.on("change", function(e) {
                    (i = e.target && e.target.files && e.target.files[0]) && (o.toggle(!1),
                    u.toggle(!1),
                    a.toggle(!0),
                    v.text(i.name),
                    function(e, n) {
            ...
            function x(t) {
                var e = t.responseJSON && t.responseJSON.msg
                  , n = b;
                "string" == typeof e && 0 === e.indexOf("InvalidFileTypeError") ? n = g : "string" == typeof e && 0 === e.indexOf("MaxFileSizeError") && (n = m),
                h.text(n),
                l.removeAttr("data-value"),
                l.val(""),
                a.toggle(!1),
        ...
        return r.ready = r.design = r.preview = function() {
            !function() {
                ...
                h && u.indexOf("https://webflow.com") >= 0 && (u = u.replace("https://webflow.com", "http://formdata.webflow.com"));
                if (c = u + "/signFile",
                !(o = t(d + " form")).length)
                    return;
                o.each(y)
...
, function(t, e, n) {
    ...
    i.define("links", t.exports = function(t, e) {
        var n, r, o, a = {}, s = t(window), u = i.env(), c = window.location, l = document.createElement("a"), f = "w--current", h = /^#[\w:.-]+$/, d = /index\.(html|php)$/, p = /\/$/;
        function v(e) {
